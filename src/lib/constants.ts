...
// System curators - always trusted (default anchor for new users)
export const SYSTEM_CURATORS = {
  // TrustWave Janitor Bot - Quality filter via downvotes
  '77599c5c4a7ba08456679d812a414037f4b01c975fb4f577187df11d189f80d3': 100,
} as const;
